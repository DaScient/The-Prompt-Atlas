    ...
    <div className="fixed inset-0 z-[100] bg-slate-950 flex flex-col items-center justify-center overflow-hidden font-display">
      ...
      <div className={`absolute bottom-16 md:bottom-20 flex flex-col items-center transition-all duration-1000 px-6 ${phase === 3 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
         <h1 className="text-3xl md:text-4xl font-bold text-white mb-2 tracking-tight text-center">
            THE PROMPT <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-amber-400">ATLAS</span>
         </h1>
         
         <div className="flex flex-col items-center gap-3 mb-8 text-center">
            <p className="text-slate-400 text-xs uppercase tracking-[0.25em]">Navigational Exploration Agent</p>
            ...
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-cyan-950/40 border border-cyan-500/30 backdrop-blur-md animate-in fade-in zoom-in duration-1000 delay-500 shadow-[0_0_15px_rgba(6,182,212,0.2)]">
                ...
                <span className="text-[9px] font-bold text-cyan-100 uppercase tracking-widest font-mono">Google Web Search Grounded</span>
            </div>
         </div>
         
         <button 
            onClick={handleEnter}
            className="group relative px-8 py-3 bg-transparent overflow-hidden rounded-full font-mono"
         >
            ...
            <div className="relative flex items-center gap-3">
                <span className="text-cyan-300 group-hover:text-white font-bold tracking-widest text-xs transition-colors">INITIALIZE ATLAS</span>
                <Play className="w-4.5 h-4.5 text-cyan-300 group-hover:text-white fill-current transition-colors" />
            </div>
         </button>
      </div>
